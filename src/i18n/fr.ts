export const fr = {
  ...
  setup_username_too_short: 'Minimum 3 caractères',
  setup_username_too_long: 'Maximum 30 caractères',
  setup_username_no_uppercase: 'Les majuscules ne sont pas autorisées',
  setup_username_invalid_chars: 'Uniquement lettres minuscules, chiffres, points et underscores',
  setup_username_no_period_edges: 'Ne peut pas commencer ou finir par un point',
  setup_username_no_consecutive_periods: 'Pas de points consécutifs',
  setup_username_hint: 'Lettres minuscules, chiffres, points et underscores uniquement',
  ...
  create_search_place: 'Rechercher un lieu...',
  create_suggested_places: 'Lieux suggérés',
  create_places_added: 'lieux ajoutés',
  ...
  create_place_price: 'Prix (€)',
  create_place_price_placeholder: '0',
  create_place_duration: 'Durée (min)',
  create_place_duration_placeholder: '30',
  create_travel_time: 'Trajet (min)',
  create_travel_time_placeholder: '10',
  create_travel_transport: 'Transport',
  create_total_price: 'Prix total',
  create_total_duration: 'Durée totale',
  create_error_numbers_only: 'Chiffres uniquement',
  create_between_places: 'Trajet entre',
  create_and: 'et',
