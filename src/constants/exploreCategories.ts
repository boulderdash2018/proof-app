    ...
    sections: [
      {
        ...
        items: [
          ...
          { name: 'Authentic Restaurant', icon: 'restaurant-outline', emoji: '🍝', gradient: ['#8B6A50', '#5C4030'] },
          ...
          { name: 'Niche / Hidden gems', icon: 'compass-outline', emoji: '🗝️', gradient: ['#5A6880', '#3A4858'] },
          { name: 'Original', icon: 'sparkles-outline', emoji: '🎪', gradient: ['#8B7530', '#5C4E20'] },
          { name: 'Loved by Proof.', icon: 'heart-outline', emoji: '🏅', gradient: ['#8B5070', '#5C3048'], hot: true },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { name: 'City Tour', icon: 'map-outline', emoji: '🧭', gradient: ['#5A6878', '#3A4858'] },
          { name: 'Nature', icon: 'leaf-outline', emoji: '🌳', gradient: ['#4A6A50', '#2D4830'] },
          { name: 'Cool neighbourhood', icon: 'location-outline', emoji: '🚶', gradient: ['#5A5048', '#3D352E'] },
          { name: 'Niche / Hidden gems', icon: 'compass-outline', emoji: '🗝️', gradient: ['#5A6880', '#3A4858'] },
          { name: 'Original', icon: 'sparkles-outline', emoji: '🎪', gradient: ['#8B7530', '#5C4E20'] },
          { name: 'Loved by Proof.', icon: 'heart-outline', emoji: '🏅', gradient: ['#8B5070', '#5C3048'], hot: true },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { name: 'Cool Places to watch', icon: 'tv-outline', emoji: '🏟️', gradient: ['#7B4A4A', '#553030'] },
          { name: 'Niche / Hidden gems', icon: 'compass-outline', emoji: '🗝️', gradient: ['#5A6880', '#3A4858'] },
          { name: 'Original', icon: 'sparkles-outline', emoji: '🎪', gradient: ['#8B7530', '#5C4E20'] },
          { name: 'Loved by Proof.', icon: 'heart-outline', emoji: '🏅', gradient: ['#8B5070', '#5C3048'], hot: true },
        ],
    ...
    sections: [
      {
        ...
        items: [
          ...
          { name: 'Hidden city only', emoji: '🌆', gradient: ['#5A5048', '#3D352E'], subtitle: 'Loin des guides touristiques', planCount: 27 },
          ...
          { name: 'Cool girl sports', emoji: '🤸', gradient: ['#8B5070', '#5C3048'], subtitle: 'Pilates, padel, climbing...', planCount: 18 },
          { name: 'Only locals know', emoji: '📌', gradient: ['#5A6878', '#3A4858'], subtitle: 'Spots 100% parisiens', planCount: 22 },
